...
cmake -DQJS_VERSION=2020-07-05 -DCONFIG_LTO=y -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 -G %VS_VERSION% %BASE_PATH%
cd %BUILD_PATH%
