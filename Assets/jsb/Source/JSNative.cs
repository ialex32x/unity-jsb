...
namespace jsb
{
    ...
    public class JSNative
    {
        ...
        [DllImport(JSBDLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "JSB_NewClassID")]
        public static extern JSClassID JS_NewClassID();

        [DllImport(JSBDLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "JSB_NewClass")]
        public static extern JS_BOOL __JSB_NewClass(JSRuntime rt, JSClassID class_id, [MarshalAs(UnmanagedType.LPStr)] string class_name, IntPtr finalizer);

        public static JS_BOOL JS_NewClass(JSRuntime rt, JSClassID class_id, string class_name, JSClassFinalizer finalizer)
        {
