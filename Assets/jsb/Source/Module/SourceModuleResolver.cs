...
namespace QuickJS.Module
{
    ...
    public class SourceModuleResolver : PathBasedModuleResolver
    {
        ...
        public override bool ReloadModule(ScriptContext context, string resolved_id)
        {
            ...
            {
                var rval = _ReloadModule(context, resolved_id, JSApi.JS_DupValue(context, module_obj));
                if (rval.IsException())
                {
        ...
        //TODO: 待整理
        private unsafe JSValue _ReloadModule(ScriptContext context, string resolved_id, JSValue module_obj)
        {
            ...
            var exports_obj = JSApi.JS_GetProperty(ctx, module_obj, context.GetAtom("exports")); //context._new_commonjs_exports(resolved_id);
